 ...
 *
 */
if ( ! class_exists( 'FPBLOCK_Field_sortable' ) ) {
  class FPBLOCK_Field_sortable extends FPBLOCK_Fields {
    ...
    public function render() {
      ...
      echo '<div class="fpblock-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="fpblock-sortable-item">';

          echo '<div class="fpblock-sortable-content">';
          ...
          FPBLOCK::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="fpblock-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
