...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.fpblock_gutenberg_blocks ) { return; }

  Object.values(window.fpblock_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'fpblock-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary fpblock-shortcode-button',
              onClick: function () {
                window.fpblock_gutenberg_props = props;
              },
            }, block.button_title ),
