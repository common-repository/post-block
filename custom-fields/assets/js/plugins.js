...
(function($) {
  ...
  function FPBLOCKAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  FPBLOCKAjaxChosen.prototype.init = function() {
  ...
  FPBLOCKAjaxChosen.prototype.events = function() {
  ...
  FPBLOCKAjaxChosen.prototype.search_field_focused = function() {
  ...
  FPBLOCKAjaxChosen.prototype.search_welcome_message = function() {
  ...
  FPBLOCKAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('fpblock-chosen', _this.options.data).done( function( response ) {
  ...
  FPBLOCKAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.fpblock-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.FPBLOCKChosenOrder($hidden_value, true);
  ...
  $.fn.FPBLOCKAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new FPBLOCKAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, FPBLOCKAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  FPBLOCKAbstractChosenOrder = (function() {

    function FPBLOCKAbstractChosenOrder() {}

    FPBLOCKAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    FPBLOCKAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    FPBLOCKAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    FPBLOCKAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    FPBLOCKAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    FPBLOCKAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    FPBLOCKAbstractChosenOrder.FPBLOCKChosenOrder = function(select, order, force) {
    ...
    return FPBLOCKAbstractChosenOrder;
  ...
  $.fn.extend({
    FPBLOCKChosenOrder: function(order, force) {
      return _FPBLOCKChosenOrder.FPBLOCKChosenOrder(this, order, force);
    }
  });

  this._FPBLOCKChosenOrder = (function(_super) {
    __extends(_FPBLOCKChosenOrder, _super);

    function _FPBLOCKChosenOrder() {
      _ref = _FPBLOCKChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _FPBLOCKChosenOrder.relAttributeName = 'data-option-array-index';

    _FPBLOCKChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _FPBLOCKChosenOrder.getDOMElement = function(element) {
    ...
    _FPBLOCKChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _FPBLOCKChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _FPBLOCKChosenOrder;

  })(FPBLOCKAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('fpblock-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('fpblock-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectFPBLOCK = FormSerializer.serializeObject;
    $.fn.serializeJSONFPBLOCK   = FormSerializer.serializeJSON;
  }
