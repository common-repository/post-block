 ...
 *
 */
if ( ! class_exists( 'FPBLOCK_Field_color' ) ) {
  class FPBLOCK_Field_color extends FPBLOCK_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="fpblock-color"'. $default_attr . $this->field_attributes() .'/>';
