 ...
 *
 */
if ( ! class_exists( 'FPBLOCK_Field_textarea' ) ) {
  class FPBLOCK_Field_textarea extends FPBLOCK_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( FPBLOCK::$shortcode_instances ) ) ? FPBLOCK::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary fpblock-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
